! function(t, e) {
    ...
    function y() {
        ...
        return Object.getOwnPropertyNames(e).forEach(function(t) {
            var r = e[t]; - 1 !== t.indexOf("aria-") || "role" === t || "type" === t ? (Ye.warn(Je(Qe, t, r)), i.setAttribute(t, r)) : "textContent" === t ? g(i, r) : i[t] = r
    ...
    function O(t) {
        ...
        var r = ye.documentElement,
            n = ye.body,
            i = r.clientLeft || n.clientLeft || 0,
            o = he.pageXOffset || n.scrollLeft,
            s = e.left + o - i,
            a = r.clientTop || n.clientTop || 0,
            l = he.pageYOffset || n.scrollTop,
            c = e.top + l - a;
        return {
            left: Math.round(s),
            top: Math.round(c)
    ...
    function q(t, e, r) {
        ...
        if (n.handlers || (n.handlers = {}), n.handlers[e] || (n.handlers[e] = []), r.guid || (r.guid = F()), n.handlers[e].push(r), n.dispatcher || (n.disabled = !1, n.dispatcher = function(e, r) {
            ...
            if (t.addEventListener) {
                ...
                or && sr.indexOf(e) > -1 && (i = {
                    passive: !0
                }), t.addEventListener(e, n.dispatcher, i)
            ...
            if (n.handlers) {
                ...
                if (void 0 !== e) {
                    ...
                    if (o) {
                        ...
                        if (r.guid)
                            for (var s = 0; s < o.length; s++) o[s].guid === r.guid && o.splice(s--, 1);
                        W(t, e)
                    }
                } else
                    for (var a in n.handlers) Object.prototype.hasOwnProperty.call(n.handlers || {}, a) && i(t, a)
            }
        }
    }
    ...
    function $(t, e, r) {
        ...
        if ("string" == typeof e ? e = {
                type: e,
                target: t
            } : e.target || (e.target = t), e = X(e), n.dispatcher && n.dispatcher.call(t, e, r), i && !e.isPropagationStopped() && !0 === e.bubbles) $.call(null, i, e, r);
    ...
    function ot(t, e) {
        return Array.isArray(t) ? it(t) : void 0 === t || void 0 === e ? it() : it([
            [t, e]
        ])
    }
    ...
    function ft(t, e, r) {
        var n = t;
        return an(e) ? (r = e, "string" == typeof t && (n = {
            uri: t
        })) : n = Sn(e, {
            uri: t
        }), n.callback = r, n
    ...
    function yt(t) {
        ...
        if ("json" in t && !1 !== t.json && (y = !0, f.accept || f.Accept || (f.Accept = "application/json"), "GET" !== p && "HEAD" !== p && (f["content-type"] || f["Content-Type"] || (f["Content-Type"] = "application/json"), d = JSON.stringify(!0 === t.json ? d : t.json))), a.onreadystatechange = e, a.onload = i, a.onerror = n, a.onprogress = function() {}, a.onabort = function() {
                c = !0
    ...
    function St(t) {
        ...
        for (e(i, t); o = r(i);)
            for (var s = 0; s < o.length; s++)
                if (n = o.charCodeAt(s), wt(n)) return "rtl";
        return "ltr"
    }
    ...
    function Gt(t, e) {
        var r = ri[t.id()],
            n = null;
        if (void 0 === r || null === r) return n = e(t), ri[t.id()] = [
            [e, n]
        ], n;
    ...
    function Jt() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            a = e[0],
            l = e.slice(1);
        if ("string" == typeof a) Jt(t, ei[a], r, i, o, s);
        else if (a) {
            var c = Gt(i, a);
    ...
    function Zt(t, e) {
        var r = void 0;
        if (4 === t.length) r = t[1] + t[1] + t[2] + t[2] + t[3] + t[3];
        else {
    ...
    var ye = ue,
        ge = he.navigator && he.navigator.userAgent || "",
        me = /AppleWebKit\/([\d.]+)/i.exec(ge),
        _e = me ? parseFloat(me.pop()) : null,
        be = /iPad/i.test(ge),
        Te = /iPhone/i.test(ge) && !be,
        Ce = /iPod/i.test(ge),
        ke = Te || be || Ce,
        Ee = function() {
        ...
        ur = function() {
            if (p() && !1 !== cr.options.autoSetup) {
                var t = ye.getElementsByTagName("video"),
                    ...
                    r = ye.getElementsByTagName("video-js"),
                    n = [];
                if (t && t.length > 0)
                    for (var i = 0, o = t.length; i < o; i++) n.push(t[i]);
                if (e && e.length > 0)
                    for (var s = 0, a = e.length; s < a; s++) n.push(e[s]);
                if (r && r.length > 0)
                    for (var l = 0, c = r.length; l < c; l++) n.push(r[l]);
                if (n && n.length > 0)
    ...
    var hr = function(t) {
        ...
        vr = function(t, e, r) {
            var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : he,
                i = void 0,
                o = function() {
    ...
    yr.prototype.allowedEvents_ = {}, yr.prototype.on = function(t, e) {
        ...
        this.addEventListener = function() {}, q(this, t, e), this.addEventListener = r
        ...
        var r = this.addEventListener;
        this.addEventListener = function() {}, Y(this, t, e), this.addEventListener = r
    }, yr.prototype.trigger = function(t) {
        var e = t.type || t;
        "string" == typeof t && (t = {
            type: e
        }), t = X(t), this.allowedEvents_[e] && this["on" + e] && this["on" + e](t), $(this, t)
    ...
    var gr = function(t) {
        ...
        Cr = function(t, e) {
            var r = e.length < 3 || e[0] === t || e[0] === t.eventBusEl_,
                n = void 0,
                i = void 0,
                o = void 0;
        ...
        Er = {
            ...
            off: function(t, e, r) {
                if (!t || mr(t)) K(this.eventBusEl_, t, e);
                else {
                    var n = t,
                        i = e;
        ...
        Sr = function() {
            function t(e, r, n) {
                ...
                this.name_ = r.name || null, r.el ? this.el_ = r.el : !1 !== r.createEl && (this.el_ = this.createEl()), !1 !== r.evented && J(this, {
                    eventBusKey: this.el_ ? "el_" : null
                }), Q(this, this.constructor.defaultState), this.children_ = [], this.childIndex_ = {}, this.childNameIndex_ = {}, !1 !== r.initChildren && this.initChildren(), this.ready(n), !1 !== r.reportTouchActivity && this.enableTouchActivity()
            }
            return t.prototype.dispose = function() {
                ...
                if (this.player() && this.player().reportUserActivity) {
                    var t = dr(this.player(), this.player().reportUserActivity),
                        e = void 0;
                ...
                var n = t.getComponent("Tech"),
                    i = n && n.isTech(r),
                    o = t === r || t.prototype.isPrototypeOf(r.prototype);
                if (i || !o) {
                    var s = void 0;
    ...
    for (var xr = {}, jr = [
        ...
        ], Ar = jr[0], Pr = void 0, Or = 0; Or < jr.length; Or++)
        if (jr[Or][1] in ye) {
            Pr = jr[Or];
            break
        } if (Pr)
        for (var Mr = 0; Mr < Pr.length; Mr++) xr[Ar[Mr]] = Pr[Mr];
    ...
    var Ir = lt,
        ...
        Hr = function(t) {
            function e(r, n) {
                ...
                return i.opened_ = i.hasBeenOpened_ = i.hasBeenFilled_ = !1, i.closeable(!i.options_.uncloseable), i.content(i.options_.content), i.contentEl_ = y("div", {
            ...
            return ze(e, t), e.prototype.createEl = function() {
                ...
                if ("boolean" == typeof t) {
                    ...
                    if (e && !r) {
                        ...
                        }), this.contentEl_ = n, this.on(r, "close", this.close)
                ...
                if (9 === t.which) {
                    for (var e = this.focusableEls_(), r = this.el_.querySelector(":focus"), n = void 0, i = 0; i < e.length; i++)
                        if (r === e[i]) {
                            n = i;
                            break
    ...
    Hr.prototype.options_ = {
        pauseOnOpen: !0,
        temporary: !0
    }, Sr.registerComponent("ModalDialog", Hr);
    var Vr = function(t) {
        function e() {
    ...
    var Wr = function(t, e) {
        ...
        vn = "function" == typeof Symbol && "symbol" == typeof Symbol.toStringTag,
        yn = function(t) {
            if (!t) return !1;
        ...
        jn = vt;
    vt.XMLHttpRequest = he.XMLHttpRequest || mt, vt.XDomainRequest = "withCredentials" in new vt.XMLHttpRequest ? vt.XMLHttpRequest : he.XDomainRequest,
        function(t, e) {
    ...
    var An = function(t, e) {
            var r = new he.WebVTT.Parser(he, he.vttjs, he.WebVTT.StringDecoder()),
                n = [];
            r.oncue = function(t) {
                e.addCue(t)
    ...
    Dn.prototype.allowedEvents_ = {
        load: "load"
    }, Dn.NONE = In, Dn.LOADING = 1, Dn.LOADED = Ln, Dn.ERROR = 3;
    var Rn = {
        audio: {
            ListClass: Ur,
            TrackClass: Mn,
    ...
    Fn.names.forEach(function(t) {
        ...
        t.registerSourceHandler = function(e, r) {
            ...
            for (var r = t.sourceHandlers || [], n = void 0, i = 0; i < r.length; i++)
                if (n = r[i].canPlayType(e)) return n;
            return ""
        }, t.selectSourceHandler = function(e, r) {
            for (var n = t.sourceHandlers || [], i = 0; i < n.length; i++)
                if (n[i].canHandleSource(e, r)) return n[i];
            return null
    ...
    var ei = {},
        ...
        ui = function t(e) {
            ...
            } else e = "string" == typeof e && e.trim() ? [Qt({
                src: e
            })] : i(e) && "string" == typeof e.src && e.src && e.src.trim() ? [Qt(e)] : [];
            return e
        },
        hi = function(t) {
            function e(r, n, i) {
                ...
                var o = et({
                    ...
                    s = We(this, t.call(this, r, o, i));
                if (n.playerOptions.sources && 0 !== n.playerOptions.sources.length) r.src(n.playerOptions.sources);
                else
    ...
    var pi = function(t) {
        ...
        return ze(e, t), e.prototype.createEl = function() {
            ...
            r = n({
                ...
                className: this.buildCSSClass(),
                tabIndex: 0
            }, r), "button" === e && Ye.error("Creating a ClickableComponent with an HTML element of " + e + " is not supported; use a Button instead."), i = n({
                role: "button"
            }, i), this.tabIndex_ = r.tabIndex;
    ...
    var fi = {
        ...
        vi = function(t) {
            function e(r, n, i) {
                Ve(this, e);
                var o = We(this, t.call(this, r, n, i)),
                    s = dr(o, o.updateDisplay);
            ...
            return ze(e, t), e.prototype.preselectTrack = function() {
                ...
                if ("function" == typeof he.WebVTT && t.activeCues) {
                    ...
                    if (he.WebVTT.processCues(he, e, this.el_), this.player_.textTrackSettings)
                        for (var n = this.player_.textTrackSettings.getValues(), i = e.length; i--;) {
                            var o = e[i];
                            if (o) {
    ...
    var yi = function(t) {
        ...
        return ze(e, t), e.prototype.createEl = function() {
            var e = this.player_.isAudio(),
                r = this.localize(e ? "Audio Player" : "Video Player"),
                n = y("span", {
                    className: "vjs-control-text",
                    innerHTML: this.localize("{1} is loading.", [r])
                }),
                i = t.prototype.createEl.call(this, "div", {
    ...
    var mi = function(t) {
        ...
        return ze(e, t), e.prototype.buildCSSClass = function() {
            ...
            ct(e) ? e.then(i, function() {}) : this.setTimeout(i, 1)
        }, e.prototype.handleKeyPress = function(e) {
    ...
    var Pi = function(t) {
        ...
        return ze(e, t), e.prototype.enabled = function() {
            ...
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
            return r.className = r.className + " vjs-slider", r = n({
                tabIndex: 0
            }, r), i = n({
                role: "slider",
                "aria-valuenow": 0,
        ...
        return ze(e, t), e.prototype.createEl = function() {
            ...
            this.rafId_ && this.cancelAnimationFrame(this.rafId_), this.rafId_ = this.requestAnimationFrame(function() {
                var n = r.player_.scrubbing() ? r.player_.getCache().currentTime : r.player_.currentTime(),
                    i = ki(n, r.player_.duration()),
                    o = r.getChild("timeTooltip");
                o && o.update(t, e, i)
            })
        }, e
    }(Sr);
    Ni.prototype.options_ = {
        children: []
    }, Ie && !(Ie > 8) || ke || we || Ni.prototype.options_.children.push("timeTooltip"), Sr.registerComponent("PlayProgressBar", Ni);
    var Ii = function(t) {
        function e(r, n) {
            Ve(this, e);
            var i = We(this, t.call(this, r, n));
    ...
    }, Sr.registerComponent("MouseTimeDisplay", Ii);
    var Li = function(t) {
        function e(r, n) {
            Ve(this, e);
            var i = We(this, t.call(this, r, n));
    ...
    var Di = function(t) {
        ...
        return ze(e, t), e.prototype.createEl = function() {
            ...
            if (e) {
                var r = e.getChild("mouseTimeDisplay"),
                    n = e.el(),
                    i = P(n),
                    o = M(n, t).x;
    ...
    Di.prototype.options_ = {
        children: ["seekBar"]
    }, Sr.registerComponent("ProgressControl", Di);
    var Ri = function(t) {
        function e(r, n) {
            Ve(this, e);
            var i = We(this, t.call(this, r, n));
    ...
    Vi.prototype.options_ = {
        children: ["volumeBar"]
    }, Sr.registerComponent("VolumeControl", Vi);
    var zi = function(t, e) {
    ...
    }, Sr.registerComponent("VolumePanel", Ui);
    var Xi = function(t) {
        function e(r, n) {
            Ve(this, e);
            var i = We(this, t.call(this, r, n));
    ...
    var qi = function(t) {
        ...
        return ze(e, t), e.prototype.update = function() {
            ...
            if (this.items = this.createItems(), this.items)
                for (var r = 0; r < this.items.length; r++) t.addItem(this.items[r]);
            return t
    ...
    var Yi = function(t) {
        ...
        return ze(e, t), e.prototype.handleClick = function(e) {
            ...
            if (n || (n = [r]), t.prototype.handleClick.call(this, e), i)
    ...
    var Ji = function(t) {
        ...
        return ze(e, t), e.prototype.createItems = function() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Yi,
                r = void 0;
    ...
    var no = function(t) {
        ...
        return ze(e, t), e.prototype.buildCSSClass = function() {
            ...
            var e = [];
            return this.player().tech_ && this.player().tech_.featuresNativeTextTracks || !this.player().getChild("textTrackSettings") || (e.push(new ro(this.player_, {
                kind: this.kind_
    ...
    var oo = function(t) {
        ...
        return ze(e, t), e.prototype.buildCSSClass = function() {
            ...
            return this.player().tech_ && this.player().tech_.featuresNativeTextTracks || !this.player().getChild("textTrackSettings") || (e.push(new ro(this.player_, {
                kind: this.label_
            })), this.hideThreshold_ += 1), e = t.prototype.createItems.call(this, e, io)
        }, e
    }(Ji);
    ...
    var co = function(t) {
        ...
        return ze(e, t), e.prototype.createEl = function() {
            ...
            var t = new Xi(this.player()),
                e = this.playbackRates();
            if (e)
                for (var r = e.length - 1; r >= 0; r--) t.addChild(new lo(this.player(), {
                    rate: e[r] + "x"
                }));
            return t
            ...
            for (var e = this.player().playbackRate(), r = this.playbackRates(), n = r[0], i = 0; i < r.length; i++)
                if (r[i] > e) {
                    n = r[i];
                    break
    ...
    }, Sr.registerComponent("ControlBar", po);
    var fo = function(t) {
        function e(r, n) {
            Ve(this, e);
            var i = We(this, t.call(this, r, n));
    ...
    var Oo = function(t, e) {
        ...
        No = function(t) {
            ...
            if (!e.resetSourceWatch_) {
                ...
                }), Object.defineProperty(e, "innerHTML", et(n, {
                    set: i(n.set)
        ...
        Bo = function(t) {
            ...
            return ze(e, t), e.prototype.dispose = function() {
                ...
                if (t.prototype.removeRemoteTextTrack.call(this, e), this.featuresNativeTextTracks)
                    for (var r = this.$$("track"), n = r.length; n--;) e !== r[n] && e !== r[n].track || this.el().removeChild(r[n])
            }, e.prototype.getVideoPlaybackQuality = function() {
    ...
    Bo.isSupported = function() {
        ...
        try {
            ...
            Object.defineProperty(ye.createElement("video"), "src", {
                ...
                get: t,
                set: t
            }), Object.defineProperty(ye.createElement("audio"), "innerHTML", {
                get: t,
                set: t
            })
        } catch (t) {
    ...
    var Ho = Bo.TEST_VID && Bo.TEST_VID.constructor.prototype.canPlayType,
        Vo = /^application\/(?:x-|vnd\.apple\.)mpegurl/i,
        zo = /^video\/mp4/i;
    Bo.patchCanPlayType = function() {
        ...
        e.setSrc(t.src)
    }, Bo.nativeSourceHandler.dispose = function() {}, Bo.registerSourceHandler(Bo.nativeSourceHandler), ti.registerTech("Html5", Bo);
    var Wo = Ue(["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "], ["\n        Using the tech directly can be dangerous. I hope you know what you're doing.\n        See https://github.com/videojs/video.js/issues/2617 for more info.\n      "]),
        ...
        qo = ["tiny", "xsmall", "small", "medium", "large", "xlarge", "huge"],
        Ko = {};
    ...
    var $o = {
        ...
        Yo = function(t) {
            function e(r, i, o) {
                if (Ve(this, e), r.id = r.id || i.id || "vjs_video_" + F(), i = n(e.getTagSettings(r), i), i.initChildren = !1, i.createEl = !1, i.evented = !1, i.reportTouchActivity = !1, !i.language)
                    if ("function" == typeof r.closest) {
                        var s = r.closest("[lang]");
                        s && s.getAttribute && (i.language = s.getAttribute("lang"))
                    } else
                        for (var a = r; a && 1 === a.nodeType;) {
                ...
                l.cache_ = {}, l.poster_ = i.poster || "", l.controls_ = !!i.controls, l.cache_.lastVolume = 1, r.controls = !1, r.removeAttribute("controls"), r.hasAttribute("autoplay") ? l.options_.autoplay = !0 : l.autoplay(l.options_.autoplay), l.scrubbing_ = !1, l.el_ = l.createEl(), l.cache_.lastPlaybackRate = l.defaultPlaybackRate(), J(l, {
                    eventBusKey: "el_"
                });
                var u = et(l.options_);
                if (i.plugins) {
            ...
            return ze(e, t), e.prototype.dispose = function() {
                ...
                var s = "string" != typeof this.autoplay() && this.autoplay(),
                    a = {
                        source: e,
                        autoplay: s,
                ...
                if (!this.changingSrc_) {
                    var r = function(t) {
                        ...
                        i = t.src;
                    if (n && !/^blob:/.test(n) && /^blob:/.test(i) && (!this.lastSource_ || this.lastSource_.tech !== i && this.lastSource_.player !== n) && (r = function() {}), r(i), !t.src) {
                        var o = function t(r) {
                            if ("sourceset" !== r.type) {
                ...
                var t = this,
                    e = this.options_.Promise || he.Promise;
                return e ? new e(function(e) {
                    t.play_(e)
                }) : this.play_()
            }, e.prototype.play_ = function() {
                var t = this,
                    e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ut;
                ...
                var e = this,
                    ...
                    i = function(t, r) {
                        var n = t[0];
                        if (t[1].canPlaySource(r, e.options_[n.toLowerCase()])) return {
                            source: r,
                            tech: n
                        }
                    };
                ...
                var t = void 0,
                    e = void 0,
                    r = void 0,
                    n = dr(this, this.reportUserActivity),
                    i = function(t) {
                ...
                if (this.responsive())
                    for (var t = this.currentBreakpoint(), e = this.currentWidth(), r = 0; r < qo.length; r++) {
                        var n = qo[r],
                            i = this.breakpoints_[n];
                        if (e <= i) {
                            if (t === n) return;
    ...
    var Jo = {},
        ...
        is = function() {
            ...
            return t.prototype.version = function() {
                ...
                if (Qo(e)) Ye.warn('A plugin named "' + e + '" already exists. You may want to avoid re-registering plugins!');
                else if (Yo.prototype.hasOwnProperty(e)) throw new Error('Illegal plugin name, "' + e + '", cannot share a name with an existing player method!');
                ...
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Object.keys(Jo),
                    e = void 0;
                return t.forEach(function(t) {
                    var r = Zo(t);
                    r && (e = e || {}, e[t] = r)
    ...
    return G(1, se), se.VERSION = le, se.options = Yo.prototype.options_, se.getPlayers = function() {
        ...
        TERMINATOR: ni
    }, se.browser = Fe, se.TOUCH_ENABLED = Re, se.extend = ss, se.mergeOptions = et, se.bind = dr, se.registerPlugin = is.registerPlugin, se.deregisterPlugin = is.deregisterPlugin, se.plugin = function(t, e) {
